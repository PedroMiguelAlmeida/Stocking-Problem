...
public class Recombination2<I extends IntVectorIndividual, P extends Problem<I>> extends Recombination<I, P> {
    ...
    int iterativeCut = firstCut;
    while(iterativeCut <= secondCut){
        firstChild[iterativeCut] = ind1.getGene(iterativeCut);
        secondChild[iterativeCut] = ind1.getGene(iterativeCut);
        iterativeCut++;
    }
